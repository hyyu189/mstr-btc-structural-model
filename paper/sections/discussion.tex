...
\textbf{Third, the premium is currently depressed.} The PMRI of $-1.51$ suggests the market is pricing Strategy conservatively relative to the model's long-run equilibrium. Under the calibrated OU dynamics (half-life of $\sim$62 calendar days), the premium is expected to mean-revert upward. Whether this represents a buying opportunity depends on whether the OU calibration (fitted primarily to the 2020--2025 sample) remains valid as the capital structure evolves with new preferred layers.
