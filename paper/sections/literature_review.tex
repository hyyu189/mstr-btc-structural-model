...
The premium dynamics we observe---with $\pi_t$ negatively correlated with BTC returns ($\rho < 0$), reflecting premium compression on BTC rallies---extend the CEF literature's sentiment patterns to the leveraged treasury setting.
